<script>
    ...
    const hiddenLabels = hideLabels? 'hidden' : '';
        ...
        <form>
            <div class="flex flex-col gap-4 sm:flex-row sm:gap-16">
                <fieldset class="flex flex-col justify-center">
                    <legend class="mx-auto pb-2 {hiddenLabels} text-lg xl:text-2xl md:text-xl">Score Settings:</legend>
                    <div class="flex flex-row gap-4 justify-center">
                        <div class="flex flex-col items-center gap-2">
                            <label class="{hiddenLabels} text-md xl:text-xl md:text-lg" for="maxScoreInput">Mode:</label>
                        ...
                        <div class="flex flex-col items-center gap-2">
                            <label class="{hiddenLabels} text-md xl:text-xl md:text-lg" for="maxScoreInput"> Max. Score:</label>
                        ...
                        <div class="w-16 sm:hidden"></div>
                    </div>
                </fieldset>
                <fieldset class="flex flex-col justify-center">
                    <div>
                        <legend class="mx-auto text-lg xl:text-2xl md:text-xl pb-2 text-center {hiddenLabels}">Score Breaks:</legend>
                    </div>
                    <div class="flex flex-row gap-4 justify-center">
